...
- **Baubit.Mediation**: Provides a `PipelineBuilder<T>` for composing middleware directly inside subscriber registrations, and focuses on cache-backed durability and distributed messaging
